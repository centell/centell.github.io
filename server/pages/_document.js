...
/* harmony import */ var _src_components_theme__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("C75p");
...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_1___default.a {
  render() {
    return __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["Html"], null, __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["Head"], null, __jsx("meta", {
      ...
      name: "theme-color",
      content: _src_components_theme__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"].palette.primary.main
    }), __jsx("linkgetInitialProps", {
      rel: "stylesheet",
...
MyDocument.getInitialProps = async ctx => {
  ...
  const styledServerStyleSheet = new styled_components__WEBPACK_IMPORTED_MODULE_2__["ServerStyleSheet"]();
  const muiServerStyleSheet = new _material_ui_core_styles__WEBPACK_IMPORTED_MODULE_3__["ServerStyleSheets"]();
  const originalRenderPage = ctx.renderPage;

  try {
    ctx.renderPage = () => originalRenderPage({
      enhanceApp: App => props => styledServerStyleSheet.collectStyles(muiServerStyleSheet.collect(__jsx(App, props)))
    });

    const initialProps = await next_document__WEBPACK_IMPORTED_MODULE_1___default.a.getInitialProps(ctx);
    return _objectSpread(_objectSpread({}, initialProps), {}, {
      // Styles fragment is rendered after the app and page rendering finish.
      styles: __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, initialProps.styles, muiServerStyleSheet.getStyleElement(), styledServerStyleSheet.getStyleElement()) // styles: [
...
const muiTheme = Object(_material_ui_core_styles__WEBPACK_IMPORTED_MODULE_0__["createMuiTheme"])({
  palette: {
    primary: {
      main: '#556cd6'
    },
...
const theme = _objectSpread(_objectSpread({}, muiTheme), {}, {
  color: {
